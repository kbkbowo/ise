...
class SawyerBoxOpenEnvV2(SawyerXYZEnv):
    ...
    def compute_reward(self, actions, obs):
        reward_grab = SawyerBoxOpenEnvV2._reward_grab_effort(actions)
        reward_quat = SawyerBoxOpenEnvV2._reward_quat(obs)
        reward_steps = SawyerBoxOpenEnvV2._reward_pos(obs, self._target_pos)
